            ...
            try
            {
                ...
                switch (consoleInput[0])
                {
                    ...
                    case "troll":
                        ...
                        break;
                    case "printTroll":
                        SpamAction.WriteLineClean("active: " + troll.isActive.ToString());
                        SpamAction.WriteLineClean("message: " + troll.message);
                        SpamAction.WriteLineClean("times: " + troll.timesToRepeat.ToString());
                        SpamAction.WriteLineClean("username: " + troll.personToTroll);
                        break;
                    ...
                    case "printUniformResponse":
                        SpamAction.WriteLineClean("active: " + uniformResponse.isActive.ToString());
                        SpamAction.WriteLineClean("message: " + uniformResponse.message);
                        SpamAction.WriteLineClean("times: " + uniformResponse.timesToRepeat.ToString());
                        break;
                    case "detectDisable":
                    ...
                    case "detect":
                        ...
                        break;
                    case "printDetect":
                        SpamAction.WriteLineClean("active: " + detect.isActive.ToString());
                        SpamAction.WriteLineClean("message: " + detect.message);
                        SpamAction.WriteLineClean("detect string: " + detect.stringToDetect);
                        SpamAction.WriteLineClean("times: " + detect.timesToRepeat.ToString());
                        break;
                    case "clear":
                        Console.Clear();
                        break;
